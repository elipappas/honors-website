        ...
        <div className="m-auto w-full max-w-3xl bg-opacity-50 bg-gray-700 p-6 shadow-lg">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="text-white text-lg leading-relaxed ml-6">
                    <h3 className="bg-white bg-opacity-10 w-fit text-xl">About Me</h3>
                    ...
                    <br />
                    <h3 className="bg-white bg-opacity-10 w-fit text-xl">Personal Goals</h3>
                    <p className="text-base font-normal">
                    ...
                    <br />
                    <h3 className="bg-white bg-opacity-10 w-fit text-xl">Honors Goals</h3>
                    <p className="text-base font-normal">
